...
time $Trimmomatic PE $Sample_R1.fastq $Sample_R2.fastq $Sample_R1-paired.fq $Sample_R1-unpaired.fq $Sample_R2-paired.fq $Sample_R2-unpaired.fq HEADCROP:3  SLIDINGWINDOW:4:15 MINLEN:30

echo ILLUMINACLIP:$Adapters:2:30:10:2 --> this option has been ignored, as the reads has already been cliped by the sequencing company. 
