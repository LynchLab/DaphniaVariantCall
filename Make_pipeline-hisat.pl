...
echo ===============================================================
echo hisat2 [options]* -x <ht2-idx> {-1 <m1> -2 <m2> | -U <r> | --sra-acc <SRA accession number>} [-S <sam>]


set -x
$hisat -x $ref_genome.fasta -1 $Sample_R1-paired.fq -2 $Sample_R2-paired.fq -U $Sample_R1-unpaired.fq  -U $Sample_R2-unpaired.fq -S $OUTPUT.sam 
set +x
echo ===============================================================
...
$n1 pbs files are produced and saved in: $DATA_DIR
  hisat-$SampleID-000.pbs, 
  hisat-$SampleID-001.pbs,
  ... ... 
  hisat-$SampleID-$n.pbs
Among which, hisat-$SampleID-000.pbs is useful for debuging.
...
To debug this pipeline, type the following commands: 
  ...
  qsub -q debug $DATA_DIR/hisat-$SampleID-000.pbs
============================================================
