...
open OUT1, ">./qsub_all_pbs-hisat.sh" or die "cannot open file: $!";
...
if(-e $Sample_R1.".fastq" && -e $Sample_R2.".fastq"){ 
	...
	echo ===============================================================
	set -x
	time $hisat -x $ref_genome.fasta -1 $Sample_R1-paired.fq -2 $Sample_R2-paired.fq -U $Sample_R1-unpaired.fq  -U $Sample_R2-unpaired.fq -S $OUTPUT.sam 
	set +x
	echo ===============================================================
...
Then, type the following commands: 
		qsub $DATA_DIR/pbs/hisat-$SampleID-000.pbs
